...
class MoxaSetupForm(QtWidgets.QWidget, Ui_Form):
    ...
    def _initActions(self):
        ...
        self.MoxaSetupThread.sig4.connect(self._pBexit)
        
        self.pB_RESTORE.clicked.connect(self._restore)
        self.MoxaSetupThread.sig5.connect(self._pBrestore)
